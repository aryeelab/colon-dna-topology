...
bedFiles <- system.file("extdata/geodata", package="ColonDNATopology")
...
gtf <- import(
    file.path(system.file("extdata", "annotation", package="ColonDNATopology"),
              "gencode.v30lift37.annotation.gtf.gz"))
